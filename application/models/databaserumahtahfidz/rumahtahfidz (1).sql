...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 28 Feb 2023 pada 09.03
...
--
ALTER TABLE `data_guru`
  ADD CONSTRAINT `data_guru_ibfk_1` FOREIGN KEY (`id_user`) REFERENCES `data_userlogin` (`id_user`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `setor_hafalan`
  ADD CONSTRAINT `setor_hafalan_ibfk_1` FOREIGN KEY (`id_guru`) REFERENCES `data_guru` (`id_guru`) ON DELETE CASCADE ON UPDATE CASCADE,
